/*
 * QR code encoder for the printable signs page.
 * QRCode for JavaScript, Copyright (c) 2009 Kazuhiko Arase, MIT license
 * (http://www.opensource.org/licenses/mit-license.php), as packaged in qrcode-terminal.
 * "QR Code" is a registered trademark of DENSO WAVE INCORPORATED.
 * Bundled into one browser file; qrSVG() helper added.
 */
(function () {
  var defs = {}, cache = {};
...
module.exports = QRCode;
  ...
  var ECL = require('./QRErrorCorrectLevel');
  // Returns an SVG string. Level M tolerates tape, glare, and sawdust reasonably well.
  window.qrSVG = function (text, opts) {
    opts = opts || {};
    var qr = new QRCode(-1, ECL[opts.level || 'M']);
